<!-- resources/views/auth/register-vendeur.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Register Vendeur</title>
...
<body>
    <div class="container mx-auto p-4">
        <div class="max-w-md mx-auto bg-white p-8 rounded-md shadow-md">
            <h1 class="text-2xl font-bold mb-4">Register Vendeur</h1>
            <form method="POST" action="{{ route('register-vendeur') }}">
                @csrf
                <div class="mb-4">
